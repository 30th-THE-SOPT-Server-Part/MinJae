...
const createUser = async (userCreateDto: UserCreateDto): Promise<PostBaseReponseDto | null> => {
    try{
...
const signInUser = async (userSignInDto: UserSignInDto): Promise<PostBaseReponseDto | null | number> => {
    try{
